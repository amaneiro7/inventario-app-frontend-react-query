...
export interface WitchButtonStyleProps {
...
export const Color = {
	...
	azul: `text-azul border border-azul bg-white hover:text-white hover:bg-azul disabled:bg-azul`
} as const

const hoverStyle = 'hover:shadow-lg disabled:translate-y-0 hover:-translate-y-1'

export function withButtonStyle<P extends object>(
