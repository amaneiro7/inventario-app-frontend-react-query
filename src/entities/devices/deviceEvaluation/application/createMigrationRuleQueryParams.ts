...
/**
 * @interface MigrationRuleFilters
 * @description Define la estructura de los filtros disponibles para buscar entidades `MigrationRule`.
 * @property {MigrationRuleDto['id']} [id] - ID de la marca.
 * @property {MigrationRuleDto['name']} [name] - Nombre de la marca.
 ...
 */
export interface MigrationRuleFilters {
	id?: string
	minRamGb?: string
	minDiskGb?: string
	isActive?: string
 ...
 * @function
 * @description Construye una cadena de parámetros de consulta (query string) a partir de un objeto `MigrationRuleFilters`.
