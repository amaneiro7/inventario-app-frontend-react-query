...
/**
 * @typedef {Object} DevicePrinterPrimitives
 ...
 */
export type DevicePrinterPrimitives = DevicePrimitives & {
	ipAddress: Primitives<IPAddressMFP>
}

/**
 * @typedef {Object} DevicePrinterParams
 ...
 * @property {Primitives<IPAddressMFP>} ipAddress - Dirección IP de la MFP.
 */
export type DevicePrinterParams = DeviceParams & {
	categoryId: CategoryOptions.MFP | CategoryOptions.INKPRINTER | CategoryOptions.LASERPRINTER
	ipAddress: Primitives<IPAddressMFP>
}

/**
 * @interface DevicePrinterDto
 * @description Data Transfer Object (DTO) para un dispositivo de tipo MFP.
 * Incluye las propiedades primitivas de la MFP.
 * @property {Primitives<IPAddressMFP>} ipAddress - Dirección IP de la MFP.
 */
export interface DevicePrinterDto {
	ipAddress: Primitives<IPAddressMFP>
}
