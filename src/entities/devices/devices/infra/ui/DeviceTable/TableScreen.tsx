...
const MonitorDescription = lazy(() =>
	import('./MonitorDescription').then(m => ({ default: m.MonitorDescription }))
)
...
export const TableScreen = memo(
	({ devices, isError, colSpan, visibleColumns }: TableScreenProps) => {
...
TableScreen.displayName = 'TableScreen'
