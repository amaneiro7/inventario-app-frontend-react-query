...
interface FinantialPrinterDescriptionProps {
	open: boolean
	device: DeviceDto
	colSpan: number
...
export const FinantialPrinterDescription = memo(
	({ open, device, colSpan, visibleColumns }: FinantialPrinterDescriptionProps) => {
		return (
			<>
...
FinantialPrinterDescription.displayName = 'FinantialPrinterDescription'
