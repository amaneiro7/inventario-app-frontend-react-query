...
export interface CentroTrabajoFilters {
	id?: CentroTrabajoDto['id']
	name?: CentroTrabajoDto['name']
	centroCostoId?: CentroTrabajoDto['centroCostoId']
	pageNumber?: number
	pageSize?: number
...
export async function createCentroTrabajoParams({
	pageNumber,
	pageSize,
	orderBy,
	orderType,
	...options
}: CentroTrabajoFilters): Promise<string> {
