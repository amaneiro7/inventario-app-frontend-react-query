...
/**
 * Defines the structure for filtering and pagination parameters when searching for directivas.
 */
export interface DirectivaFilters {
	id?: DirectivaDto['id']
...
/**
 * Creates a query string for searching directivas based on provided filters and pagination options.
 ...
 */
export async function createDirectivaParams({
	pageNumber,
	pageSize,
	orderBy,
	orderType,
	...options
}: DirectivaFilters): Promise<string> {
