...
export class ReactivateAccount {
	 ...
	 * @param reactivateAccountRepository - The repository responsible for resetting user passwords.
	 * @param events - The event manager to notify about the operation's progress (loading, success, error).
	 */
	constructor(
		private readonly reactivateAccountRepository: ReactivateAccountRepository,
