...
import { useSiteMapChart } from '@/widgets/monitoring/AdmSiteChart/Model/useSiteMapChart'
...
const LocationDetailsPanel = lazy(() =>
	import('@/widgets/monitoring/AdmSiteChart/ui/LocationDetailsPanel').then(m => ({
		default: m.LocationDetailsPanel
	}))
)

const MonitoringSiteMapChart = () => {
	const {
...
export default MonitoringSiteMapChart
