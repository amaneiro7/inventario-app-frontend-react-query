...
export function TableCellDescEdit({ state, url, stateId }: Props) {
	return (
		<p className=" w-min text-xs flex flex-row align-middle justify-center items-center gap-1 text-azul">
			...
			>
				<EditIcon className="ml-2 w-6 p-1 aspect-square bg-verde text-white rounded" />
			</Link>
		</p>
	)
}
